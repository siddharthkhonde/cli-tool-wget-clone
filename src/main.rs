...
use cli_tool_wget_clone::download::{ftp_download, http_download};
use cli_tool_wget_clone::utils;
...
fn run() -> Fallible<()> {
    let args = clap_app!(Cli_tool_wget_clone =>
    (version: crate_version!())
    (author: "Siddharth Khonde <siddharthk435@gmail.com>")
    ...
    (@arg AGENT: -U --useragent +takes_value "identify as AGENT instead of cli_tool_wget_clone/VERSION")
